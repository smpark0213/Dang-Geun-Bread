...
public class Signup01Activity extends AppCompatActivity {
    ...
    private void checkEmail(String email) {
        fAuth.signInWithEmailAndPassword(email, "12")
                .addOnCompleteListener(com.example.map_test.Signup01Activity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                        ...
                        if (task.getException() instanceof FirebaseTooManyRequestsException) {
                            ...
                            switch (errorCode) {
                                ...
                                case "ERROR_USER_NOT_FOUND":
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), com.example.map_test.Signup02Activity.class);
