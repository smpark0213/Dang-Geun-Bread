    ...
    public void onMapReady(final GoogleMap googleMap) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( StoreRegister.this, REQUIRED_PERMISSIONS,
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                AlertDialog.Builder alert = new AlertDialog.Builder(StoreRegister.this);

                alert.setTitle("빵집 이름을 입력해주세요");
                alert.setMessage("Plz, input store name");

                final EditText name = new EditText(StoreRegister.this);
                alert.setView(name);
                ...
                alert.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        //다이어로그 생성
                        AlertDialog.Builder builder = new AlertDialog.Builder(StoreRegister.this);
